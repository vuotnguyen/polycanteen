 ...
 */
class OrderStaticFrag : Fragment() {
    ...
    override fun onCreateView(
        ...
        var view = inflater.inflate(R.layout.fragment_order_static, container, false)
        view.textView15.setOnClickListener { requireActivity().onBackPressedDispatcher.onBackPressed() }
        view.textView16.text = "Đơn hàng"
        view.textView17.text = "Tìm Kiếm"
        return view
    }
